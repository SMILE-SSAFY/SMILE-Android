...
class ServiceInstances(retrofitInstances : RetrofitInstances) {
    ...
    @Singleton
    private val portfolioApiService: PortfolioApiService = retrofitInstances.getRetrofit().create(
        PortfolioApiService::class.java)

    @Singleton
    private val likeApiService: LikeApiService = retrofitInstances.getRetrofit().create(
        LikeApiService::class.java)
